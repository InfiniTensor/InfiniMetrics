...
### Getting Started
- [Installation Guide](./installation.md) - Prerequisites, dependencies, and build instructions
...
- [Configuration](./configuration.md) - Input format and parameter reference


### Reference
- [Output Format](./output_format.md) - Understanding test results and output structure
- [Development](./development.md) - Adding adapters, metrics, and extending the framework
...
4. [Output Format](./output_format.md)
